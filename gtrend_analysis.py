...
def get_trend(keyword, date_time):
  ...
  plt.savefig("trend"+keyword[0]+".png")
  plt.close()
  ...
  plt.xticks(rotation=90)
  plt.savefig("log_trend"+keyword[0]+".png")
  plt.close()
  """
  ...
  print(data_interest.head(3))

kw_list = [
  "Countertop Microwave Ovens", "Stand Mixers", "TVs", "Portable Air Conditioners", "Inkjet Printers", "Air Fryers", "Projectors", "Cordless Drills",
  "Stand-Up Paddleboards", "Treadmills", "Smartwatches"
  ] #List of Categories
for kw in kw_list:
  keyword.append(kw)
